...
export default function HomeScreen() {
  ...
  const openWhatsApp = async () => {
    const phone = '919380596236';
    const message = 'ನಮಸ್ಕಾರ, ನನಗೆ ಹೆಚ್ಚಿನ ಮಾಹಿತಿ ಬೇಕು';
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          {locationPermission === 'denied' && (
            <View style={styles.permBanner}>
              <Text style={styles.permText}>📍 Location access is required for local services</Text>
              <TouchableOpacity onPress={loadWeather} style={styles.permBtn}>
        ...
        <View style={styles.voiceSection}>
          ...
          <TouchableOpacity onPress={startVoiceAssist} activeOpacity={0.8} style={styles.micButtonContainer}>
            <View style={[styles.micBlur, { backgroundColor: '#ffffff', justifyContent: 'center', alignItems: 'center' }]}>
              <MaterialCommunityIcons name="robot-happy" size={50} color={c.primary} />
            </View>
          </TouchableOpacity>
        ...
        <View style={styles.trackerContainer}>
          <View style={[styles.glassCard, { backgroundColor: '#ffffff' }]}>
        ...
        <View style={styles.weatherContainer}>
          <View style={[styles.weatherCard, { backgroundColor: '#ffffff' }]}>
            {loadingWeather ? (
              ...
              <View style={styles.weatherLoading}>
                ...
                <TouchableOpacity onPress={loadWeather} style={{ marginTop: 10, backgroundColor: '#ffffff', paddingHorizontal: 15, paddingVertical: 8, borderRadius: 15 }}>
        ...
        >
          <View style={styles.aiModalContainer}>
            <View style={[styles.aiModalSheet, { backgroundColor: '#ffffff' }]}>
              <View style={styles.aiModalHeader}>
                <View style={styles.aiLabel}>
                  <MaterialCommunityIcons name="robot-outline" size={18} color={c.primary} />
              ...
              <ScrollView style={styles.aiScroll} showsVerticalScrollIndicator={false}>
                ...
                {!aiThinking && !isVoiceRecording && !aiResponse && !pickedImage && (
                  <View style={{ alignItems: 'center', paddingTop: 30, opacity: 0.6 }}>
                    <MaterialCommunityIcons name="robot-outline" size={60} color={c.primary} />
...
const styles = StyleSheet.create({
  ...
  glassCard: { padding: 22, borderRadius: 20, elevation: 4, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 10, borderWidth: 0 },
  sectionTitle: { fontSize: 18, fontWeight: 'bold', color: '#111', marginBottom: 15 },
  progressRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  progressStep: { alignItems: 'center' },
  progressLine: { flex: 1, height: 2, backgroundColor: '#eee', marginHorizontal: 10, marginTop: -15 },
  ...
  insightCard: { flexDirection: 'row', padding: 20, borderRadius: 20, alignItems: 'center', backgroundColor: '#ffffff', elevation: 4, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 10 },
  insightDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: '#00C853', marginRight: 15 },
  insightText: { fontSize: 14, color: '#333', lineHeight: 20, fontWeight: '500' },
  insightAction: { marginTop: 10, alignSelf: 'flex-start' },
  noteBtn: { width: 44, height: 44, borderRadius: 12, backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#000' },
  ...
  noteCard: { backgroundColor: '#ffffff', padding: 18, borderRadius: 15, marginBottom: 12, elevation: 2, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 5 },
  ...
  weatherCard: { padding: 22, borderRadius: 25, elevation: 4, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 10, borderWidth: 0 },
  ...
  weatherCity: { fontSize: 13, color: '#666', fontWeight: 'bold' },
  weatherTemp: { fontSize: 38, fontWeight: '900', color: '#1B5E20', marginTop: 5 },
  weatherCond: { fontSize: 16, color: '#444', fontWeight: '500' },
  weatherDetails: { flexDirection: 'row', gap: 20, marginTop: 15, borderTopWidth: 1, borderTopColor: '#ddd', paddingTop: 15 },
  weatherItem: {},
  weatherLabel: { fontSize: 10, color: '#888', fontWeight: 'bold' },
  weatherVal: { fontSize: 14, fontWeight: 'bold', color: '#333' },
  weatherTip: { marginTop: 15, backgroundColor: '#ffffff', padding: 10, borderRadius: 12, flexDirection: 'row', alignItems: 'center', gap: 8 },
  ...
  aiInputArea: { paddingVertical: 15, borderTopWidth: 1, borderTopColor: '#ddd' },
  aiActionRow: { flexDirection: 'row', gap: 12, marginBottom: 15, paddingHorizontal: 5 },
  aiInputRow: { flexDirection: 'row', gap: 10, alignItems: 'flex-end' },
  aiInput: { flex: 1, backgroundColor: '#f8f8f8', borderRadius: 20, paddingHorizontal: 20, paddingVertical: 15, minHeight: 60, maxHeight: 120, fontSize: 16, borderWidth: 1, borderColor: '#bbb' },
  aiSendBtn: { width: 55, height: 55, borderRadius: 28, justifyContent: 'center', alignItems: 'center', elevation: 2 },
  micBtn: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#E8F5E9', justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#00C853' },
  micPulseRing: { position: 'absolute', width: 80, height: 80, borderRadius: 40, backgroundColor: 'rgba(255,59,48,0.2)' },
  extraBtn: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#f5f5f5', justifyContent: 'center', alignItems: 'center' },
  ...
  permBanner: { backgroundColor: '#FF6D00', padding: 12, borderRadius: 15, marginBottom: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  permText: { color: '#fff', fontSize: 13, fontWeight: 'bold', flex: 1 },
  permBtn: { backgroundColor: '#fff', paddingHorizontal: 15, paddingVertical: 6, borderRadius: 10 },
  permBtnText: { color: '#FF6D00', fontWeight: 'bold', fontSize: 13 },
  whatsappFab: {
    position: 'absolute',
    bottom: 25,
    right: 25,
